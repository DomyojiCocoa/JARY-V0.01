            ...
            <div class="relative bg-Color2 border-[#fcb815] border-2 w-1/2 md:w-1/3 lg:w-1/4 rounded-lg shadow-lg">
                <div class="p-8">
                    ...
                    <form action="{{ route('site.create') }}" method="get">
                        <label for="" class="text-[#fcb815]">Nombre del sitio</label>
                        <input type="text" name="name">
                        <label for="" class="text-[#fcb815]">Direccion</label>
                        <input type="text" name="address">
                        <div>
                            <label for="" class="text-[#fcb815]">hora de inicio</label>
                            <div>
                        ...
                        <label for="" class="text-[#fcb815]">Hora de cierre</label>
                        <div>
                            <input type="time" name="horasalida">
                        </div>
                        <label for="" class="text-[#fcb815]">Tipo de Clima</label>
                        <div class="">
                            <x-weathers></x-weathers>
                        </div>
                        <label for=""class="text-[#fcb815]">URL de la foto</label>
                        <div>
                            <input type="text" name="url_foto">
                        </div>
                        <label for=""class="text-[#fcb815]">URL de dirrecion</label>
                        <div>
                            <input type="text" name="url_map">
                        </div>
                        <div class="flex justify-center items-center pt-7">
                            <button type="submit" class="w-20 bg-white font-bold py-2 px-4 rounded hover:bg-[#fcb815]"class="w-64">Enviar</button>
                        </div>
        ...
        <table class="m-w-full  divide-y divide-gray-200">
            <thead class="bg-[#1e293b]">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3  text-xs font-medium text-white uppercase tracking-wider">Direccion</th>
                    ...
                    <th scope="col" class="px-9 py-3 w-6text-left text-xs font-medium text-white uppercase tracking-wider text-center">Opciones</th>
                </tr>
            </thead>
                                ...
                                <div class="flex items-center justify-center min-h-screen">
                                    <div class="relative bg-Color2 border-[#fcb815] border-2 w-1/2 md:w-1/3 lg:w-1/4 rounded-lg shadow-lg">
                                        <div class="p-8">
                                            ...
                                            <!-- Contenido del modal -->
                                            <h2 class="text-xl font-semibold mb-4 text-[#fcb815]">Editar informacion sitio</h2>
                                            <form action="{{ route('site.update', $site)}}" method="post">
                                                ...
                                                <label for="" class="text-[#fcb815]">Hora de apertura</label>
                                                <div class="py-4">
                                                ...
                                                <label for="" class="text-[#fcb815]">Climas para recomendar</label>
                                                <div class="py-4">
                                                ...
                                                <label for="" class="text-[#fcb815]">Imagen del sitio</label>
                                                <div class="py-4">
                                                    <input type="text" placeholder="url_foto" name="url_foto" value="{{ $site->url_img }}" class="w-64">
                                                </div>
                                                <label for="" class="text-[#fcb815]">Link del mapa</label>
                                                <div class="py-4">
