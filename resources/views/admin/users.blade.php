...
<x-app-layout>
    <div x-data="{ showModal: false }" class="bg-Color2">
        <div class="flex p-8">
            <button @click="showModal = true" class="bg-yellow-500 hover:bg-red-400 text-white font-bold  w-32 h-12 rounded">
                Crear usuario
            </button>
        </div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center flex">
                        <div x-data="{ showModal: false }">
                            <div>
                                <button @click="showModal = true" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            ...
                            <div x-show="showModal" class="fixed z-10 inset-0 overflow-y-auto">
                                <div class="flex items-center justify-center min-h-screen">
                                    <div class="relative bg-white border-yellow-500 border-2 w-1/2 md:w-1/3 lg:w-1/4 rounded-lg shadow-lg">
                                        <div class=" text-right pb-4">
                                            <button @click="showModal = false" class="text-sm font-semibold text-white bg-red-700 font-bold py-2 px-4 rounded ">X</button>
                                        </div>
                                        <div class="p-1">
                                            <!-- Contenido del modal -->
                                            <h2 class="text-xl font-semibold mb-4 text-yellow-500 ">Editar usuario</h2>
                                            <form action="{{ route('user.update',$user->id) }}" method="post">
                                                ...
                                                <div class="flex justify-center items-center pt-7">
                                                    <button type="submit" class="w-23 bg-red-500 font-bold py-2 px-2 rounded hover:bg-yellow-500" >Actualizar</button>
                                                </div>
