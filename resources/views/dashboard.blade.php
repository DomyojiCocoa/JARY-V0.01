<x-app-layout>
    ...
    <div class="prueba h-screen p-28">
        ...
        <h1 class="text-[#fbbf24] text-5xl sm:text-8xl md:text-9xl lg:text-10xl xl:text-11xl text-center font-semibold">Clima actual</h1>
        <h2 class="text-[#0F172A] text-3xl text-center	 font-extrabold pt-7" id="ola">{{ $temp . ", ". $weather }}</h2>
    </div>
    <section class="bg-[#0F172A] w-full h-36 pl-12 items-center">
        ...
        <div class="flex justify-between pr-9 pt-2">
            ...
            <div class=" pr-1">
                <button  class="bg-white hover:bg-red  w-32 h-12 hover:bg-[#ef4444] transition ease-in-out"><a href="{{ route('recommendation') }}">Generar guia</a></button>
            </div>
        </div>
    </section>
    <section class=" w-full h-36 bg-gradient-to-r from-[#0F172A] to-[#fbbf24] pl-12">
        ...
        <div class="flex justify-between pr-9 pt-2">
            ...
            <div class="pr-1">
                <button class="bg-white hover:bg-red  w-32 h-12 hover:bg-[#ef4444] transition ease-in-out"><a href="{{ route('site.catalogue') }}">Ver sitios</a></button>
            </div>
